<template>
    <div class="edit">
        ...
        <div id="divToEdit" class="d-flex justify-content-center ml-5 mr-5 pl-5 pr-5">
            <form method="PUT" @submit.prevent="updateNbaTeam">
                <div class="row">
                    ...
                    <div class="form-group col-lg-6 col-sm-12">
                        ...
                        <input class="form-control" v-model="model.abbreviation" value="model.abbreviation" type="text" />
                    </div>
                    <div class="form-group col-lg-6 col-sm-12">
                        <label>City</label>
                    ...
                    <div class="col-lg-12 col-sm-12 pull-right">
                        ...
                        <input type="submit" variant="success" class="btn btn-success" value="Edit" />
                    </div>
                </div>
            </form>
        </div>
    ...
    export default {
        ...
        methods: {
            async updateNbaTeam() {
                ...
                await api.updatePut(this.$route.params.id, this.model)
                await api.getAll("")

                this.errors.errors.length = 0; //to reset errors messages
            },
            async teamToUpdate(id) {

                this.model = await api.updateGet(id)
                return this.model
            },
        },
        mounted() {
            this.teamToUpdate(this.$route.params.id)
        }
    }
</script>
